...
entering `npm i --save @authorizerdev/authorizer-svelte`. To setup the project for Authorizer, we will need to 
...
> I won't explain SvelteKit forms here, but if their [documentation][7] is amazing, as well as their
...
new and complex fairly easily. As an overview, let's check all of the files in one place:

// maybe StackBlitz demo to show files and functionality
